        ...
        <div className="-mx-4 flex flex-wrap items-center gap-y-10">
          <div className="w-full px-4 lg:w-2/5">
            <div className="overflow-hidden rounded-2xl shadow-one ring-1 ring-black/5 dark:ring-stroke-dark">
              <img
                src="/images/keymaking/keys-fobs-arranged.jpeg"
                alt="Range of keys and smart fobs we cut and program"
                className="h-full w-full object-cover"
              />
            </div>
          </div>
          <div className="w-full px-4 lg:w-3/5">
            <div className="grid grid-cols-1 gap-4 xs:grid-cols-2 sm:gap-x-8 sm:gap-y-10">
              {items.map((item, i) => (
                <div
                  key={item.title}

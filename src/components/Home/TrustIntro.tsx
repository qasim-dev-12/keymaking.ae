        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            <h2 className="mb-5 text-xl font-bold leading-tight text-black dark:text-white sm:text-3xl md:text-4xl">
              Reliable Locksmith Services — Keeping You Secure, Anytime,
              Anywhere
            </h2>
            <p className="mb-8 text-base leading-relaxed text-body-color">
              Whether you're locked out at 3 AM or need a same-day key
              replacement, our team delivers fast, professional locksmith
              services across Dubai — for homes, businesses, and vehicles.
            </p>
          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="overflow-hidden rounded-2xl shadow-one ring-1 ring-black/5 dark:ring-stroke-dark">
              <img
                src="/images/keymaking/locksmith-handover.jpeg"
                alt="Locksmith handing over car key to customer in Dubai"

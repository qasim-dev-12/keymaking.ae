    ...
    <section className="bg-gray-dark py-10 text-center md:py-20">
      <div className="container">
        ...
        <p className="mx-auto mt-8 max-w-[600px] text-xs text-white/50">
          ...
          location as scheduled, if for any reason the work is canceled or
          cannot be carried out, a cancellation fee equivalent to 50% of the
          agreed service charge will be applicable.
        </p>
      </div>
    </section>
  );

const bullets = [
  {
    ...
    icon: <img src="/images/logo/logo50.png" alt="Key Making Dubai" className="h-6 w-6 object-contain sm:h-7 sm:w-7" />,
    text: "Emergency? Get 24/7 Locksmith Help Now!",
    short: "24/7 Emergency Help",
  },
  {
    bg: "bg-blue-500",
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5"><path d="M14.7 6.3a4 4 0 0 0-5.4 5.4L4 17l3 3 5.3-5.3a4 4 0 0 0 5.4-5.4l-2 2-2-2 2-2Z"/></svg>,
    text: "Automotive Locksmith Services",
    short: "Automotive Locksmith",
  },
  {
    bg: "bg-green-600",
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5"><path d="M3 12l9-9 9 9 M5 10v10h14V10 M14 20v-6h-4v6"/></svg>,
    text: "Residential Locksmith Services",
    short: "Residential Locksmith",
  },
  {
    bg: "bg-orange-500",
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5"><path d="M6 11V7a6 6 0 0 1 12 0v4 M5 11h14v10H5z"/></svg>,
    text: "Commercial Locksmith Services",
    short: "Commercial Locksmith",
  },
  {
    bg: "bg-yellow-600",
  ...
  },
  {
    ...
    text: "Available Across Dubai, 24/7",
    short: "Available Across Dubai",
  },
];
...
const Hero = () => {
  return (
    <>
      ...
      >
        <div
          className="absolute inset-0 z-[-1] bg-cover bg-[center_30%] opacity-[0.08] dark:opacity-[0.15]"
          style={{ backgroundImage: "url('/images/keymaking/car-key-dubai-street.jpeg')" }}
        />
        <div className="absolute inset-0 z-[-1] bg-gradient-to-b from-white via-white/70 to-white dark:from-gray-dark dark:via-gray-dark/70 dark:to-gray-dark" />
              ...
              <div className="mx-auto max-w-[800px] text-center">
                <div className="mb-4 flex justify-center">
                  <span className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5 text-xs font-semibold text-primary ring-1 ring-primary/30 dark:bg-primary/15">
                    ...
                    Locksmiths Online Now — Avg. Response 20 min
                  </span>
                </div>
                <h1 className="mb-5 text-2xl font-bold leading-tight text-primary sm:text-4xl sm:text-black sm:leading-tight sm:dark:text-white md:text-5xl md:leading-tight">
                  Fast, Reliable Locksmith Services in Dubai
                </h1>
              </div>
            </div>
          </div>
